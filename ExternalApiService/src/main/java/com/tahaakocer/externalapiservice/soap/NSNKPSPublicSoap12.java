...
public class NSNKPSPublicSoap12
{
    ...
    public NSNKPSPublicSoap12()
    {
    }

    public NSNKPSPublicSoap12(String url)
    {
        this.url=url;
    }

    public NSNKPSPublicSoap12 (String url,NSNConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        NSNRequestResultHandler handler = new NSNRequestResultHandler(NSNSoapVersion.v1_2);
        return handler;
    }
